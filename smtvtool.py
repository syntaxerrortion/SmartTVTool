...
def main():
    ...
    print(f"{Fore.YELLOW}{Style.BRIGHT}{figlet_format('  Smart TV Tool')}")
    ...
    if selection == "1":
        ...
        print(f"{Fore.YELLOW}{Style.BRIGHT} [*] Installing Requirements..")
        pip_install_code = os.system("pip install requests colorama pyfiglet")
        apt_install_code = os.system("sudo apt install -y nmap adb")

        if pip_install_code == 0 and apt_install_code == 0:
            print(f"{Fore.YELLOW}{Style.BRIGHT} [+] Requirements installed successfully!")
        else:
            print(f"{Fore.YELLOW}{Style.BRIGHT} [-] Error installing requirements!")
