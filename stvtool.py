        ...
        if devices:
            ...
            if 0 <= target_index < len(devices):
                ...
                if connect_code == 0 and "unable to connect" not in connect_output.lower() and "cannot connect to" not in connect_error.lower():
                    ...
                    if push_code == 0:
                        targetfilename = input(Fore.YELLOW + Style.BRIGHT + " [*] filename mp4: ")
                        ...
                        print(Fore.YELLOW + Style.BRIGHT + " [+] It's being published..")
                        print(Fore.YELLOW + Style.BRIGHT + " [+] Complete.")
